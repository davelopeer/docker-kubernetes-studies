...
We will have 3 steps in deployment:

1. Pushing code to Github
2. Testing it on Travis CI
3. Deploy in AWS

## Github

For Github, we simply need to create a public repository and push our code into it.

## Travis CI

Travis is a Continuous Integration plataform that allows our github code to run a specific command every time we push a commit to Github.

To use it on our project, we will:

1. Tell Travis we need a copy of docker running;
2. Build our image using Dockerfile.dev;
3. Tell Trabis how to run our test suite;
